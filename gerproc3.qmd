...
public:
    ...
    std::chrono::system__clock_::time_point start_time; ///< Tempo de criação
    ...
    TaskStruct(bool is_thread = false, 
        ...
        : pid(next_pid_++), state(TaskState::TASK_RUNNING), flags(0),
          cred(), start_time(std::chrono::system__clock_::now()) {
...
- **Better _cache_ locality** com estruturas embeded
...
3. **Registradores de Tabelas de Descritores (Hardware Real)**
    ...
    - _cache_ interno mantém base/limite da LDT atual;
...
- **Tempo de TLB Hit**: 1-2 ciclos de _clock_;
...
private:
    ...
    std::unordered_map<uint64_t, bool> tlb_cache_; ///< _cache_ simulado da TLB
